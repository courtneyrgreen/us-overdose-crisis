...
::: {.card-body style="text-align: center; padding-bottom: 0.6rem;"}
...
<iframe src="outputs/smaller_addiction_lineplot.html" scrolling="no" style="border:none; width:100%; height:430px;"></iframe>
:::
:::::
...
::: {.card-body style="background: white; padding: 0;"}
<iframe src="outputs/us_overdose_map_state.html" scrolling="no" style="border:none; width:100%; height:600px;"></iframe>
:::
:::::

### Column{width=30%}
::: {.callout-note appearance="minimal"}
Let's take a preview of the geographic distribution of drug overdose deaths across the US states. The choropleth map below shows overdose deaths on a state level, calculated per capita and log transformed for normality.

Darker shades indicate higher overdose death rates relative to population. States in the **Mid-Atlantic, Appalachian region, and parts of the West** tend to show elevated rates, reflecting the uneven geographic toll of the opioid crisis. Log transformation was applied to reduce the influence of extreme outliers and make state-to-state differences easier to compare visually.
:::
...
::: {.card-body style="background: white; padding: 0;"}
<iframe src="outputs/plotly_county_metrics_map.html" scrolling="no" style="border:none; width:100%; height:500px;"></iframe>
:::
:::::
...
:::
::: {.card-body style="background: white; padding: 0; padding-top: 2.5rem;"}
<iframe src="outputs/race.html" scrolling="no" style="border:none; width:100%; height:510px;"></iframe>
<iframe src="outputs/gender_substance.html" scrolling="no" style="border:none; width:100%; height:490px;"></iframe>
:::
:::::
...
-   **Males account for the majority of admissions across all substances**, particularly alcohol, heroin, and cocaine.
-   **The gender gap is narrowest for tranquilizers and amphetamines**, suggesting females are proportionally more affected by prescription drug misuse than by illicit drugs.
:::
...
::: {.card-body style="background: white;"}
<iframe src="outputs/scatterplot_density.html" scrolling="no" style="border:none; width:100%; height:490px;"></iframe>
:::
:::::
...
fig_map = px.choropleth(
    ...
    labels={
        "percent_of_adults_who_are_high_school_graduates_or_equivalent_2019-23": "HS Diploma<br>Only (%)"
    },
)

fig_map.update_layout(
    coloraxis_colorbar=dict(
        title=dict(text="HS Diploma<br>Only (%)", font=dict(size=12)),
        thickness=15,
        len=0.75,
        x=1.02,
    ),
...
fig_map.write_html("img/education_choro.html")
...
# app.run(debug=True, port=8055)  # disabled for static render
```
...
::: card-body
<iframe src="img/education_choro.html" width="100%" height="600px" style="border: none;"></iframe>
:::
:::::

::: {.callout-note appearance="minimal"}
Above, we present a choropleth that relates the percentage of adults whose highest level of education is a high school diploma by state. States such as West Virginia and Arkansas have extremely high percentages, while Colorado and Massachusetts have low percentages.

We wanted to further explore the connection between education, drug use, and age. Use the dropdown below to select any state and compare substance use rates across age groups.

**Marijuana and amphetamine use tend to peak in younger age groups (21–35)**, while alcohol and opioid use persist more broadly across age groups. **States with lower high school graduation rates tend to show higher overall substance use**, particularly among younger adults. The only two states without data are Oregon and Nevada.
:::

::::: {.card collapse="true"}
::: card-header
Drug Use by Age Group by State
:::

::: {.card-body style="background: white; padding: 0;"}
<iframe src="outputs/state_drug_age.html" scrolling="no" style="border:none; width:100%; height:520px;"></iframe>
:::
:::::